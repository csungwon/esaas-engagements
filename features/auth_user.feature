@wig
Feature: only staff can edit, destroy and create users, orgs, apps, engagements, iterations
...
Background: Logged in, users, apps, orgs, engagements and iterations exist 
  ...
  And the following users exist:
    | id | name  | github_uid      | email          | type of user  |
