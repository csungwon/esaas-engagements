...
Scenario: user can reset a form for New User
	...
	And I select "Staff" from "User Type"
...
Scenario: user can reset a form for New Engagement
	...
	And I select "Berkeley Student Cooperative" from "Coaching Organization"
	...
	And the "Coaching Organization" field should contain "4"
...
Scenario: user can reset a form for Edit Engagement
	...
	And I select "UC Berkeley CS169" from "Coaching Organization"
	And I select "Adnan Hemani" from "Coach"
	And I select "Armando Fox" from "Contact"
	...
	And the "Coaching Organization" field should contain "1"
