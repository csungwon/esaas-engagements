...
Scenario: User can submit a create form including user type and SID for Student
   And I follow "Create"
   Given I fill in the "User Information" fields as follows:
       | field               | value                 |
       | User Name           | Fakeuser              |
...
Scenario: User can submit a create form including user type and SID for Staff
   And I follow "Create"
   Given I fill in the "User Information" fields as follows:
       | field               | value                 |
       | User Name           | Professor              |
